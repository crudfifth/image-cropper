...
const buttonClass = computed(() => [
  'flex items-center justify-center py-2 px-4 mr-2 rounded transition text-white duration-300 font-bold',
  props.disabled ? 'bg-slate-300 hover:bg-slate-300 cursor-default' : ' bg-blue-500 hover:bg-blue-600',
]);
</script>
