# Generated by Django 4.2.6 on 2023-11-01 02:53
...
def create_and_set_pushlog_api(apps, schema_editor):
    ...
    # 全てのdeviceについて、それぞれのuser_idが参照するuserのpushlog_api_keyを取得し、
    # pushlog_apiを作成し、deviceのpushlog_api_idに設定する
    for device in Device.objects.all():
        try:
            user = User.objects.get(pk=device.user_id.pk)
            if user.pushlog_api_key is not None:
                ...
                device.pushlog_api_id = pushlog_api.id
                device.save()
